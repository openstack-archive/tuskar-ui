...
Tuskar-UI is a user interface for `Tuskar </stackforge/tuskar>`_, a management API for OpenStack deployments.  It is a plugin for `OpenStack Horizon <https://wiki.openstack.org/wiki/Horizon>`_.
...
Follow the `Installation Guide </stackforge/tuskar-ui/blob/master/docs/install.rst>`_ to install Tuskar-UI.
...
* `tuskar_ui/api.py </stackforge/tuskar-ui/blob/master/tuskar_ui/api.py>`_ - This file contains all the API calls made to the Tuskar API (through python-tuskarclient).
* `tuskar_ui/infrastructure </stackforge/tuskar-ui/tree/master/tuskar_ui/infrastructure>`_ - The Tuskar UI code is contained within this directory.  Up to this point, UI development has been focused within the resource_management/ subdirectory.
