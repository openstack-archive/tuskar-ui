...
class CreateProfile(flavor_tables.CreateFlavor):
    verbose_name = _("New Node Profile")
    url = "horizon:infrastructure:profiles:create"


class UpdateProfile(flavor_tables.UpdateFlavor):
    verbose_name = _("Edit Node Profile")
    url = "horizon:infrastructure:profiles:update"


class DeleteProfile(flavor_tables.DeleteFlavor):

    def __init__(self, **kwargs):
        super(DeleteProfile, self).__init__(**kwargs)
