...
def iconized_node_power_state(node_power_state):
  power_state_string_dict = {
            'active': 'powered on',
  ...
  state = power_state_string_dict.get(node_power_state, "&mdash;")
  icon = power_state_icon_dict.get(node_power_state, None)
