...
INDEX_URL = reverse('horizon:infrastructure:resources_unallocated:index')
...
class UnallocatedNodesTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        tuskar.BaremetalNode.list(IsA(http.HttpRequest)).AndReturn(unallocated_nodes)
        self.mox.ReplayAll()

        res = self.client.get(INDEX_URL)
        self.assertTemplateUsed(
            res, 'infrastructure/resources_unallocated/index.html')
