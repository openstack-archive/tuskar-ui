...
class ItemsCountTab(tabs.Tab):
    def get_items_count(self):
        """This method should return a count string that is added after
        tab name in template. Required.
        """
        raise NotImplementedError("%s needs to define a get_count "
                                  "method." % self.__class__.__name__)


class DeployedTab(ItemsCountTab, tabs.TableTab):
...
class FreeTab(ItemsCountTab, tabs.TableTab):
