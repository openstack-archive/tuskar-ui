...
class EditServiceConfig(horizon.forms.SelfHandlingForm):
    ...
    def handle(self, request, data):
        ...
        parameters.update(self._load_additional_parameters(plan, data, 'snmp_password', 'SnmpdReadonlyUserPassword'))
        parameters.update(self._load_additional_parameters(plan, data, 'extra_config', 'ExtraConfig'))
