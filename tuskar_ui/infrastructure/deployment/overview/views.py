...
from tuskar_ui.infrastructure.deployment.overview import forms
...
class RegisterView(horizon.forms.ModalFormView):
    ...
    template_name = 'infrastructure/deployment/overview/register.html'
    success_url = reverse_lazy(
        'horizon:infrastructure:deployment.overview:index')
