...
INDEX_URL = urlresolvers.reverse('horizon:infrastructure:'
                                 'deployment.overview:index')
REGISTER_URL = urlresolvers.reverse('horizon:infrastructure:'
                                    'deployment.overview:register')
...
class RegisterNodesTests(test.BaseAdminViewTests):
    def test_index_get(self):
        ...
        self.assertTemplateUsed(
            res, 'infrastructure/deployment/overview/index.html')

    def test_register_get(self):
        res = self.client.get(REGISTER_URL)
        self.assertTemplateUsed(
            res, 'infrastructure/deployment/overview/register.html')
