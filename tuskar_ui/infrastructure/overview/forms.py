...
class PostDeployInit(horizon.forms.SelfHandlingForm):
    ...
    def build_endpoints(self, plan):
        ...
        return {
            ...
            "ec2": {
                "password": plan.parameter_value('GlancePassword')},
            "glance": {
                "password": '165ef63947964289f8e14890116bef8dec859871'},
            "heat": {
                "password": plan.parameter_value('HeatPassword')},
            "neutron": {
                "password": '1a8dd6a81f930e956e5ee1cc42b1aa4b44b5bea3'},
            "nova": {
                "password": 'efd36cde6ec9f80f1ca08aebe433064a564194cb'},
            "novav3": {
                "password": plan.parameter_value('NovaPassword')},
            "swift": {
                "password": plan.parameter_value('SwiftPassword')},
    ...
    def handle(self, request, data):
        try:
            ...
            admin_token = '9ff8cb3a5fa339ad0c61ae6ccca18d2ab48f3aef'
            admin_password = '7d34f740d7ba3b046a694b320313d5cd929e5ca3'
