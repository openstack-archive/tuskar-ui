...
class FlavorTemplatesForm(flavor_templates_forms.EditFlavorTemplate):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cpu'].widget = tuskar_forms.NumberInput(
                attrs={'class':'number_input_slim', 'read_only': True},
        )
        self.fields['memory'].widget = tuskar_forms.NumberInput(
            attrs={'class':'number_input_slim'},
        )
        self.fields['storage'].widget = tuskar_forms.NumberInput(
            attrs={'class':'number_input_slim'},
        )
        self.fields['ephemeral_disk'].widget = tuskar_forms.NumberInput(
            attrs={'class':'number_input_slim'},
        )
        self.fields['swap_disk'].widget = tuskar_forms.NumberInput(
            attrs={'class':'number_input_slim'},
        )
