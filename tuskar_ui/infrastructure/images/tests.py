...
class ImagesTest(test.BaseAdminViewTests):
    ...
    def test_create_post(self):
        ...
        mocked_create.assert_called_once_with(
            mock.ANY, name='Fedora', container_format='bare', min_ram=512,
            disk_format='qcow2', copy_from='http://test_url.com',
    ...
    def test_update_post(self):
        ...
        mocked_update.assert_called_once_with(
            mock.ANY, image.id, name='Fedora',
            container_format='bare', disk_format='qcow2', protected=False,
