...
from tuskar_ui.infrastructure.images.properties import forms as project_forms
from tuskar_ui.infrastructure.images.properties import tables as project_tables
...
class PropertyMixin(object):
    ...
    def get_success_url(self):
        return reverse("horizon:infrastructure:images:properties:index",
                       args=(self.kwargs["id"],))


class IndexView(PropertyMixin, tables.DataTableView):
    table_class = project_tables.PropertiesTable
    template_name = 'infrastructure/images/properties/index.html'
...
class CreateView(PropertyMixin, forms.ModalFormView):
    ...
    template_name = 'infrastructure/images/properties/create.html'
...
class EditView(PropertyMixin, forms.ModalFormView):
    ...
    template_name = 'infrastructure/images/properties/edit.html'
