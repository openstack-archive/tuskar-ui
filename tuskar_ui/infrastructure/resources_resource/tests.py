...
INDEX_URL = reverse('horizon:infrastructure:resources_resource:index')
...
class ResourceNodesTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        tuskar.BaremetalNode.list(IsA(http.HttpRequest)).AndReturn(resource_nodes)
        self.mox.ReplayAll()

        res = self.client.get(INDEX_URL)
        self.assertTemplateUsed(
            res, 'infrastructure/resources_resource/index.html')
